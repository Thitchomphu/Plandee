...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: Theme.colors.background }, content: { padding: Theme.spacing.xl, paddingBottom: 36, gap: Theme.spacing.lg }, back: { color: Theme.colors.primary, fontSize: Theme.type.label, fontWeight: '600', minHeight: 44 }, title: { color: Theme.colors.text, fontSize: Theme.type.page, fontWeight: '800' }, subtitle: { color: Theme.colors.muted, fontSize: Theme.type.label, marginBottom: 8 } });
