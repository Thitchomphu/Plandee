...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: Theme.colors.background }, content: { padding: 22, paddingBottom: 36, gap: 14, backgroundColor: '#FFFBF3' }, notch: { color: Theme.colors.border, fontSize: 28, lineHeight: 12, textAlign: 'center', marginBottom: 6 }, title: { color: Theme.colors.text, fontSize: 20, fontWeight: '800' }, subtitle: { color: Theme.colors.muted, fontSize: 13, marginBottom: 2 }, label: { color: Theme.colors.text, fontSize: 13, fontWeight: '600' }, statuses: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, status: { minHeight: 40, paddingHorizontal: 14, justifyContent: 'center', borderRadius: Theme.radius.pill, backgroundColor: Theme.colors.surface, borderWidth: 1, borderColor: Theme.colors.border }, activeStatus: { backgroundColor: Theme.colors.primary, borderColor: Theme.colors.primary }, statusText: { color: Theme.colors.muted, fontSize: 13 }, activeStatusText: { color: '#FFFFFF', fontWeight: '700' } });
