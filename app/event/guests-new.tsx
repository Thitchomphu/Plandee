...
import { addGuest, deleteGuest, getGuest, type RSVPStatus, updateGuest } from '@/data/guests';
...
export default function GuestFormScreen() {
  ...
  const save = async () => {
    if (!name.trim() || !group.trim()) return Alert.alert('ข้อมูลไม่ครบ', 'กรุณากรอกชื่อและประเภทแขก');
