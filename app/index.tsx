...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: Theme.colors.background }, content: { flex: 1, justifyContent: 'space-between', paddingHorizontal: 24, paddingVertical: 24 }, logoGroup: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12 }, logo: { width: 80, height: 80 }, brand: { color: Theme.colors.primary, fontFamily: Fonts.displayBold, fontSize: 36 }, tagline: { color: Theme.colors.text, fontFamily: Fonts.display, fontSize: 17, marginTop: 12 }, subtagline: { color: Theme.colors.muted, fontFamily: Fonts.sans, fontSize: 15 }, actions: { gap: 8 }, loginLink: { minHeight: 48, alignItems: 'center', justifyContent: 'center' }, loginText: { color: Theme.colors.muted, fontFamily: Fonts.sans, fontSize: 14 } });
