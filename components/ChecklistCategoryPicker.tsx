...
const styles = StyleSheet.create({ group: { gap: 8 }, label: { color: Theme.colors.text, fontSize: 13, fontWeight: '600' }, options: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, option: { minHeight: 40, justifyContent: 'center', paddingHorizontal: 14, borderRadius: Theme.radius.pill, backgroundColor: Theme.colors.surface, borderWidth: 1, borderColor: Theme.colors.border }, active: { backgroundColor: Theme.colors.primary, borderColor: Theme.colors.primary }, optionText: { color: Theme.colors.muted, fontSize: 13 }, activeText: { color: '#FFFFFF', fontWeight: '700' } });
