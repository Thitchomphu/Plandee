...
const styles = StyleSheet.create({ card: { backgroundColor: Theme.colors.surface, borderRadius: Theme.radius.lg, overflow: 'hidden', flex: 1, minWidth: 0, shadowColor: '#2B2233', shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 2 }, art: { height: 82, alignItems: 'center', justifyContent: 'center' }, artText: { color: '#FFFFFF', fontSize: 30 }, body: { padding: 14, gap: 4 }, category: { color: Theme.colors.muted, fontFamily: Fonts.sans, fontSize: Theme.type.caption }, name: { color: Theme.colors.text, fontFamily: Fonts.display, fontSize: Theme.type.body, fontWeight: '600' }, price: { color: Theme.colors.primary, fontFamily: Fonts.sansSemiBold, fontSize: Theme.type.label, fontWeight: '700' }, pressed: { opacity: 0.8 } });
