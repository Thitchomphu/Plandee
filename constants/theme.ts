export const Theme = {
  colors: { background: '#FFFBF9', surface: '#FFFFFF', input: '#FFFBF9', text: '#2B2233', muted: '#6B5E73', primary: '#E9436F', primarySoft: '#FFF0F3', border: '#F0E6DA', success: '#1F8467', warning: '#FFB648', placeholder: '#B4B4B4' },
