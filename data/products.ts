...
export const products: Product[] = [
  { id: 'venue', name: 'สถานที่จัดงาน', category: 'สถานที่', price: '฿120,000', color: '#B7A2E0' },
  ...
  { id: 'photography', name: 'ช่างภาพและวิดีโอ', category: 'ภาพและวิดีโอ', price: '฿40,000', color: '#E9436F' },
];
